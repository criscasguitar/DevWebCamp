...
<section class="speakers">
    <h2 class="speaker__heading">Speakers</h2>
    <p class="speaker__descripcion">Conoce a nuestros expertos de DevWebCamp</p>
...
<section class="boletos">
    ...
    <p class="boletos__descripcion">Precios par DevWebCamp</p>
